                ...
                <div class="row gutters-sm">
                    <div class="col-md-5 mb-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        <h4><?= $profile->nama ?></h4>
                                        <p class="text-secondary mb-1"><?= ($profile->status == 1) ? 'Active' : 'Non Active'; ?></p>
                        ...
                        <div class="collapse" id="collapseExample">
                            <div class="card mt-3">
                                <?php echo form_open('user', array('id' => 'resetForm', 'autocomplete' => "off")); ?>
                    ...
                    <div class="col-md-7">
                        <div class="card mb-3">
                            <div class="card-body">
                                <?php echo form_open('profile', array('id' => 'editForm', 'autocomplete' => "off")); ?>
                                <div class="row">
                                    <div class="col-sm-3">
