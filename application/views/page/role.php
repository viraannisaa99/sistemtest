            ...
            <div class="collapse" id="collapseExample">
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column">
                        <?= form_open('role', array('id' => 'add-form', 'autocomplete' => "off")); ?>
                        <div class="col-md-12">
                                ...
                                <?php foreach ($permission as $row) : ?>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="permission[]" id="permission[]" value="<?= $row->permission_id; ?>"><?= $row->action; ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?= form_open('role', array('id' => 'editModalForm', 'autocomplete' => "off")); ?>
                        <div class="col-md-12">
                            <div class="form-group form-float">
                            ...
                            <div class="form-group form-float">
                                ...
                                if (is_array($permission)) {
                                    foreach ($permission as $row) : ?>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="permission_id[]" id="permission_id[]" value="<?= $row->permission_id ?>">
                                                <?= $row->action ?>
                                            </label>
                                        </div>
                                <?php endforeach;
        ...
        <div class="modal fade" id="showModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?= form_open('role', array('id' => 'showModalForm', 'autocomplete' => "off")); ?>
                        <table class="table">
                            <tr>
                                <th>Nama</th>
                                <td>:</td>
